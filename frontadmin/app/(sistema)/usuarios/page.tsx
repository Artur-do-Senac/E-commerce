                                ...
                                {usuarios.map((usuario) => (
                                    <tr key={usuario.id} className="transition hover:bg-slate-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${statusStyles[usuario.status]}`}>
                                                {statusLabels[usuario.status]}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex justify-end gap-4">
                                                <Link href={`/usuarios/${usuario.id}`} className="font-semibold text-primary-600 hover:text-primary-700">Editar</Link>
