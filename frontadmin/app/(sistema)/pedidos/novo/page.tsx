        ...
        <div className="w-full flex-1 bg-slate-50">
            <div className="mx-auto flex w-full max-w-2xl flex-col gap-8 px-8 pt-10 pb-10">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <h1 className="bg-gradient-to-r from-primary-900 to-primary-600 bg-clip-text text-3xl font-extrabold tracking-tight text-transparent">Novo Pedido</h1>
                        <p className="mt-1 text-sm text-slate-500">Preencha os campos para registrar um novo pedido.</p>
                    </div>
